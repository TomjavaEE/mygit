...
<div class="right">
        ...
        <div class="providerAdd">
            <form id="userForm" name="userForm" method="post" action="<%=request.getContextPath()%>/user/useraddsave">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/statics/js/useradd.js"></script>
