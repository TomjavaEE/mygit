...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
    <div class="right">
        ...
        <form id="userForm" name="userForm" method="post" action="<%=request.getContextPath()%>/user/updateUser">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/statics/js/usermodify.js"></script>
